...
<input type="hidden" id="saldoku" name="uang" value="">
         ...
         <b> <p style="font-size: 14px; text-align: center; margin-top: 25px; margin-left: 10px; margin-right: 10px;"><strong style="color: #FF0000; text-decoration: underline"> Belum Menerima Kode Aktivasi ? </strong></p></b>
        </div>
       </center>
       <b>
